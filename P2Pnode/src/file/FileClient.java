...
//	    System.out.println("warto�� pliku: "+ft.getFolder().values());
...
//	    System.out.println("data modyfikacji: "+ft.getFolder().get(key).getHistory().getLast().getData());
            System.out.println("wysy�am ��danie udost�pnienia pliku: " + key + " modyfikowanego o " + ft.getFolder().get(key).getHistory().getLast().getData());
            key += "\n";
    ...
    public void receiveFile(FolderTree ft, Nod n, InputStream is, String path, String name, String usr) throws Exception {
        ...
        try {
            ...
            FileOutputStream outputStream = new FileOutputStream(new java.io.File(path + System.getProperty("file.separator") + tempStamp + name));
            ...
            java.io.File filenameWithTempStamp = new java.io.File(path + System.getProperty("file.separator") + tempStamp + name);
            MFolderListener.ignorowanyPlik = name;
            java.io.File docelowyPlik = new java.io.File(path + System.getProperty("file.separator") + name);
            ...
            docelowyPlik = new java.io.File(path + System.getProperty("file.separator") + name);
            if (docelowyPlik.exists()) {
                docelowyPlik.setLastModified(data);
            }//to powinno ustawi� date modyfikacji
            ...
            if (docelowyPlik.lastModified() == data) {
                ...
                System.out.println("czas modyfikaci mia� by�: " + data);
