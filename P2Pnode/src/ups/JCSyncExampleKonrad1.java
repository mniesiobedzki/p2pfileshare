...
public class JCSyncExampleKonrad1 {

    public static final Logger LOG = Logger.getLogger(JCSyncExampleKonrad1.class);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            example.initLayer("127.0.0.1", 21000, "Konrad", 22211);
        } catch (Throwable e) {
