...
public class JCSyncExample2TEST {

    public static final Logger LOG = Logger.getLogger(JCSyncExample2TEST.class);
    ...
    public static void main(String args[]) {
        ...
        JCSyncExample2TEST example = new JCSyncExample2TEST();
